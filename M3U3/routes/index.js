...
/* GET home page. */
// Esta ruta se encarga de renderizar la página principal (index.hbs o index.ejs, dependiendo de tu motor de plantillas)
router.get('/', function(req, res, next) {
  // res.render('index', { title: 'M3U3 Express' });
  res.render('index'); // Renderiza tu vista 'index'
});
